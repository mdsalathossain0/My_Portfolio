...
const Contact = () => {
  return (
    <section id='contact' className='bg-fifth pt-14  pb-10 lg:py-22'>
        <Container>
          <Heading className='text-center' text='CONTACT'/>
          <ComText className='w-full lg:w-[700px] mx-auto py-4 lg:py-8 text-center px-4 lg:px-0' text='Feel free to Contact me by submitting the form below and I will get back to you as soon as possible.'/>
          <Flex className='flex-col lg:flex-row lg:items-center pt-5 gap-y-10 lg:gap-y-0'>
            ...
            <div className='w-full lg:w-1/2'>
            <div className='w-[88%] mx-auto bg-white py-5 px-10  rounded-xl'>
              ...
              <div className='flex justify-center py-8'><Button text='Message'/></div>
            </div>
            </div>
          </Flex>
        </Container>
