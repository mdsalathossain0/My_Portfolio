        ...
        <Container>
            ...
            <Flex className='gap-x-5 md:gap-x-10 lg:gap-x-28 items-center'>
             ...
             <div className='text-center'>
              ...
              <ComText className='pb-15 px-4 lg:px-0' text="I'm a Professional Front-End Developer specializing in React, creating responsive, user-focused web interfaces with clean code, performance optimization, and modern design."/>
