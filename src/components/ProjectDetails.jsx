...
const ProjectDetails = ({title, catagory , image}) => {
  return (
    <div className='bg-white py-5 px-5 rounded-2xl drop-shadow-2xl relative group/main'>
        <div className='w-[350px] h-[210px] bg-fifth flex justify-center items-center rounded-2xl'>
            <div className='w-[320px] h-[180px] bg-blue-700 rounded-2xl'>
            ...
            <div className='w-full h-full rounded-2xl absolute top-0 left-0 flex gap-x-4 justify-center items-center bg-gradient-to-l from-[#57606f]  to-[#a4b0be]  opacity-0 group-hover/main:opacity-70 transition-all duration-500 text-black text-2xl font-bold font-robo cursor-pointer'>
